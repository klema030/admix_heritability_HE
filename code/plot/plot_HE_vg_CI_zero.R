...
# CGF
filename="admix_CGF_HE_vg_CI_P0_P9_cov_grms.txt"
df_CGF_CI=read.table(filename, header=T)
# HI
filename="admix_HI_HE_vg_CI_P0_P9_cov_grms.txt"
df_HI_CI=read.table(filename, header=T)

#remove pos and neg covs
df_CGF_CI = df_CGF_CI[!(df_CGF_CI$cov %in% "pos"),]
df_CGF_CI = df_CGF_CI[!(df_CGF_CI$cov %in% "neg"),]
df_HI_CI = df_HI_CI[!(df_HI_CI$cov %in% "pos"),]
df_HI_CI = df_HI_CI[!(df_HI_CI$cov %in% "neg"),]
...
ggsave("HE_vg_wowganc_CI_zero.png", plot=plt,
